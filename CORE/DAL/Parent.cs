...
namespace CORE.DAL
{
    public class Parent
    {
        ...
        {
            this.Id = parent.Id;
            this.StudentName = parent.StudentName;
            this.StudentAge  = parent.StudentAge;
            this.StudentNationalId = parent.StudentNationalId;
            this.StudentGender = parent.StudentGender;
            this.ParentName = parent.ParentName;
            this.ParentAddress = parent.ParentAddress;
            this.ParentPhone = parent.ParentPhone;
            this.ParentEmail = parent.ParentEmail;
            this.ParentNationalId = parent.ParentNationalId;
        }
